...
<!-- Data table -->
<table id="list" class="datagrid" border='1' cellspacing='0' align="center" width="99%">
         ...
         <tr class=<?php echo $class;?> >
             ...
             <td class="tools">
			 <!-- tool box -->
			 <span><?php echo anchor('users_controller/confirmUnlink/'.$this->native_session->userdata('project').'/'.$row->id, 'Remove','class="delete_button"') ; ?></span>
			 </td>
         </tr>
