...
if ($query->num_rows() > 0 || $this->native_session->userdata('search')!==NULL) : ?>
...
<table id="list" class="datagrid" width="100%" align="center" border='1' cellspacing='0' >
         ...
         <tr class=<?php echo $class;?> >
			 ...
			 <span><?php echo anchor('projects_controller/edit_project/'.$row->id.'/2', '<span>V</span>','class="view_button"') ; ?></span>
             <span><?php echo anchor('projects_controller/edit_project/'.$row->id.'/1', '<span>E</span>','class="edit_button"') ; ?></span>
			 <span><?php echo anchor('Users_controller/viewUnlinkedUsers/'.$row->id, '+Add Users','class="_button"') ; ?></span>
			 <span><?php echo anchor('Users_controller/viewLinkedusers/'.$row->id, '-Remove Users','class="_button"') ; ?></span>
			 <span><?php echo anchor('', '<span>-D</span>','class="delete_button"') ; ?></span>
			 <?php endif;?>
			 </td>
         </tr>
...
<table  class="datagrid" align="center">
    <tr class="down">
		...
		<!-- Display total -->
		<td>
			<?php echo 'Total '.($this->native_session->userdata('projects')).' projects.';?>
		</td>
		<!-- space -->
        <td>&nbsp;&nbsp;</td>
		<!-- search options-->
