...
{
    echo '<div class="msg_info">'.$text.'</div>';
}
...
<table id="list" class="datagrid" width="70%" border='1' cellspacing='0' >
         ...
         <tr class=<?php echo $class;?> >
             ...
             <td class="tools">
			 <!-- tool box -->
			 <span><?php echo anchor('projects_controller/unlinkUser/'.$this->session->userdata('project').'/'.$row->id, 'Remove','class="delete_button"') ; ?></span>
			 </td>
         </tr>
